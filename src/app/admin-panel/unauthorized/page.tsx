...
export const metadata: Metadata = {
  title: "Access denied · Jixu Entertainments Admin",
  ...
  return (
    <div className="mx-auto flex min-h-[60vh] max-w-md flex-col items-center justify-center gap-6 text-center">
      ...
      <div className="space-y-2">
        <h1 className="text-2xl font-bold font-space">No write access</h1>
      ...
      <div className="flex gap-2">
        <a
          ...
          className="inline-flex h-10 items-center rounded-xl border px-4 text-xs font-semibold hover:bg-[var(--bg-card-hover)] font-space"
        ...
        <Link
          href="/"
          className="inline-flex h-10 items-center rounded-xl bg-[var(--accent)] px-4 text-xs font-bold text-white hover:opacity-90 font-space shadow-xs"
        >
          Back to site
        </Link>
      </div>
